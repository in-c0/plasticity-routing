...
Asserted **equivalent** to protocol v1.0 (`protocol_v1_lock.json`) on every scientific field:
...
Admitted deltas: the admissible commit, the source-tree hash, and newly recorded artefact hashes ['selected_policy_sha256', 'comparator_sha256']. No world, objective, action space, architecture, checkpoint, comparator, threshold, seed or statistic changed.
